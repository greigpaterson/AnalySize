...
If users encounter bugs or problems using AnalySize, or have any suggestions for improving the software, we would really like to hear from as all input is welcome.If you use AnalySize in your work, please make it clear what version was used and the what method of unmixing was used. We would also be grateful if you cited the publication that introduced AnalySize: Paterson, G. A., and D. Heslop (2015), AnalySize: Software for analyzing and unmixing sediment grain size distribution spectra, Journal, vol., pages, doi: xxxxx/xxxxxx.

More information on how to use AnalySize can be found in Paterson & Heslop (2015) and in the instruction manual packaged with AnalySize.
