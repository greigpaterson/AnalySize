...
All_Settings = [{'PlotColorFile'},...
  {'DataFaceColor'}, {'DataSymbol'}, {'DataSymbolSize'},...
  {'TernFaceColor'}, {'TernSymbol'}, {'TernSymbolSize'},...
    {'CMFaceColor'}, {'CMSymbol'}, {'CMSymbolSize'},...
    {'SEM_DataFaceColor'}, {'SEM_DataSymbol'}, {'SEM_DataSymbolSize'},...
    {'SEM_EMFaceColor'}, {'SEM_EMSymbol'}, {'SEM_EMSymbolSize'},...
    {'SEM_OLFaceColor'}, {'SEM_OLSymbol'}, {'SEM_OLSymbolSize'},...
...
for ii=1:nSettings
    ...
    if strcmpi(All_Settings{ii}, 'PlotColorFile')
        ...
        try
            ...
            Defaults.Data_Plot_Color = tmp_input.Data_Plot;
            Defaults.Tern_Plot_Color = tmp_input.Tern_Plot;
            Defaults.CM_Plot_Color = tmp_input.CM_Plot;
            
            Defaults.SEM_Box_Plot_Color = tmp_input.SEM_Box;
            Defaults.SEM_Data_Plot_Color = tmp_input.SEM_Data_R2;
            Defaults.SEM_EM_Plot_Color = tmp_input.SEM_EM_R2;
            Defaults.SEM_Median_Plot_Color = tmp_input.SEM_Median;
            Defaults.SEM_Outlier_Plot_Color = tmp_input.SEM_Outlier;
